...
const CreateOffer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res?.data?.insertedId) {
        ...
        Swal.fire("❌ Submission Failed", "Could not submit your Offer. Please try again.", "error");
      }
    } catch (err) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-gradient-to-br from-base-200 to-base-300 rounded-2xl shadow-primary shadow-lg my-10 transition-all duration-300 ">
      <div className="text-center mb-8">
        <h2 className="text-4xl font-extrabold text-primary mb-2">Create Your Offer</h2>
        <p className="text-lg text-base-content/80">
          Capture everyone's attention with a stunning Offer.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="form-control">
          <label className="label">
            <span className="label-text text-lg font-semibold">📢 Offer Title</span>
          </label>
          <input
            type="text"
            value={adTitle}
            onChange={(e) => setAdTitle(e.target.value)}
            placeholder="e.g., 50% Discount on Onion"
        ...
        <div className="form-control">
          ...
          <textarea
            ...
            placeholder="e.g Buy 1 and get Discount!"
