...
const ThemeToggle = () => {
  ...
  // Load saved theme on first mount this checks the previously stored theme in the system, it is saved on local storage.
  useEffect(() => {
  ...
  // Handle toggle switch in this case i am using daisy UIs abyss theme as dark
