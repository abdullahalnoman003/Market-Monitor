    ...
    <div className="navbar bg-base-100/90 backdrop-blur-md shadow-md fixed px-6 max-md:pl-1 top-0 z-50">
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            <li><NavLink to="/dashboard/admin/all-users">All Users</NavLink></li>
      ...
      <div className="navbar-end flex items-center gap-2">
        ...
        {user && (
          <div className="dropdown dropdown-end">
            ...
            >
              <li><NavLink to="/dashboard/admin/profile" className="text-sm">Profile</NavLink></li>
              <li>
                <button
